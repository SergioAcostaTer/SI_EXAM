...
|-----------|-----|-----------------|-----------------|--------|
| **DES** | 1976 | 64 bits | 56 bits (efectivos) | ⛔ Roto. Clave demasiado corta. Roto en 22h con hardware dedicado (1998). |
| **3DES / TDES** | 1998 | 64 bits | 112/168 bits | ⚠️ Obsoleto. Aún permitido por PCI-DSS pero en desuso. Bloque pequeño vulnerable a Sweet32. |
| **IDEA** | 1992 | 64 bits | 128 bits | ⚠️ Usado en PGP. Patente expirada en 2012. Seguro pero bloque pequeño. |
...
| **Uso** | Base de DSA (Digital Signature Algorithm) y de algunas implementaciones de GPG. |
...
|------------------------------------------------|------|
| **AES-256-GCM** | AEAD (cifrado + autenticación) |
| **AES-128-GCM** | AEAD |
| **ChaCha20-Poly1305** | AEAD (alternativa a AES, rápida en CPU sin AES-NI) |
| **GOST** (en Rusia) | AEAD (algoritmo nacional ruso) |
